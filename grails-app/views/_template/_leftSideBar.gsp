<aside class="left-sidebar">
    ...
    <div class="scroll-sidebar">
        <!-- User profile -->
        <div class="user-profile" style="background: url(${assetPath(src: '/background/user-info.jpg')}) no-repeat;">
            <!-- User profile image -->
            <div class="profile-img"> <img src="${assetPath(src: '/users/profile.png')}"  alt="user" /> </div>
            <!-- User profile text-->
